...
Add the following content under cloudera-manager.repo

[source,bash]
[cloudera-manager]
name = Cloudera
baseurl = http://154.61.69.150/cloudera-repos/cm/5/5.16.2/cm/
gpgkey=http://154.61.69.150/cloudera-repos/cm/5/5.16.2/cm/RPM-GPG-KEY-cloudera
gpgcheck=1
